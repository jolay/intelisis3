<?php
$i_class = 'item-i';
if (isset($frame) && ($frame == 'bordered' || $frame == 'simple-bordered')){
  $i_class .= ' ac-frame-on';
}
?>
<li<?php print drupal_attributes($attrs)?>><article class='<?php print $i_class?>'>
<?php if (!empty($media)): ?>
  ...
  <div class="o-info">
    ...
    <?php if (isset($link) || isset($details)):?>
      <div class='meta link-details<?php if (isset($link) && isset($details)):?> single-link<?php endif?>'>
