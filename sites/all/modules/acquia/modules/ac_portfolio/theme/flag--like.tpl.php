...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
   <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" rel="nofollow">
    <?php print theme('acquia_media_feature', array('type' => 'like'));?>
    <span class="like-count"><?php print $likes?>&nbsp;<span><?php print format_plural((int)$likes, t('Like'), t('Likes'))?></span></span>
   </a>
  <?php else: ?>
  ...
  <?php if ($after_flagging): ?>
    <span class="<?php print $message_classes; ?>">
      <span class="inner"><?php print $message_text; ?></span>
    </span>
  <?php endif; ?>
</span>
<?php if ($needs_wrapping_element): ?>
