...
<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" class="wrap ac-admin" id="ac-slider-form">
  ...
  <input type="hidden" name="slider_play" value="0">
	...
	<h2>
		<?php print t('Edit this Elastic Slider') ?>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="5"><input type="text" name="height" value="<?php echo $slider['properties']['height'] ?>"> (px)</td>
						</tr>
					...
					<tr>
						...
						<td>
							<select name="animation">
									<?php foreach(elastic_slider_animation_types() as $mn => $type):?>
						...
						<td class="right"><?php print t('autoplay') ?></td>
						<td><input type="checkbox" class="checkbox" name="autoplay"<?php echo isset($slider['properties']['autoplay']) && $slider['properties']['autoplay'] == 'true' ? ' checked="checked" ' : '' ?>data-help="<?php print print t('if turned On the slider will automatically slide, and it will only stop if the user clicks on a thumb')?>"></td>
					</tr>
					
					<tr>
						<td class="right"></td>
						<td class="right"><?php print t('Slideshow interval') ?></td>
						<td><input type="text" name="slideshow_interval" value="<?php echo $slider['properties']['slideshow_interval']?>" data-help="<?php print t('interval for the slideshow')?>"> (ms)</td>
						
						<td class="right"><?php print t('Speed') ?></td>
						<td><input type="text" name="speed" value="<?php echo $slider['properties']['speed']?>" data-help="<?php print t('speed for the sliding animation')?>"> (ms)</td>
						
						<td class="right"><?php print t('titles Factor') ?></td>
						<td><input type="text" name="titlesFactor" value="<?php echo $slider['properties']['titlesFactor']?>" data-help="<?php print t('percentage of speed for the titles animation. Speed will be speed * titlesFactor')?>"></td>
					</tr>
					
					<tr>
						<td class="right"></td>
						<td class="right"><?php print t('Title speed') ?></td>
						<td><input type="text" name="titlespeed" value="<?php echo $slider['properties']['titlespeed']?>" data-help="<?php print t('titles animation speed')?>"> (ms)</td>
						
						<td class="right"><?php print t('Titles easing') ?></td>
						<td colspan="3">
							<select name="titleeasing">
									<?php foreach(acquia_easing_types() as $mn => $type):?>
										<option value="<?php print $mn?>"<?php echo ($slider['properties']['titleeasing'] == $mn) ? 'selected="selected"' : '' ?>><?php print $type ?></option>
									<?php endforeach?>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="right"><?php print t('Thumb MaxWidth') ?></td>
						<td><input type="text" name="thumbMaxWidth" value="<?php echo $slider['properties']['thumbMaxWidth']?>" data-help="<?php print t('maximum width for the thumbs in pixels')?>"></td>
					</tr>
				</table>
