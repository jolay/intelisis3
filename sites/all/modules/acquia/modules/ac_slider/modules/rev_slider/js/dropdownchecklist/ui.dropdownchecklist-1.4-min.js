...
*/
 ...
 $.widget("ui.dropdownchecklist", {
  ...
  _handleKeyboard: function(e) {
   ...
   } else if (self.dropWrapper.isOpen && (e.target.type == 'checkbox') && ((keyCode == $.ui.keyCode.DOWN) || (keyCode == $.ui.keyCode.UP))) {
  ...
  _toggleDropContainer: function(makeOpen) {
   ...
   var show = function(instance) {
    if (!instance.dropWrapper.isOpen) {
      ...
      ****/
     if ((config.positionHow == null) || (config.positionHow == 'absolute')) { /** Floats above subsequent content, but does NOT scroll */
      instance.dropWrapper.css({
       position: 'absolute',
       top: instance.controlWrapper.position().top + instance.controlWrapper.outerHeight() + "px",
       left: instance.controlWrapper.position().left + "px"
      });
     } else if (config.positionHow == 'relative') { /** Scrolls with the parent but does NOT float above subsequent content */
      instance.dropWrapper.css({
       position: 'relative',
       top: "0px",
       left: "0px"
     ...
     } else { /* Explicit set from the optins */
   ...
   if (makeOpen) {
    ...
    hide(self);
		...
		var b = this.dropWrapper.find(".ui-dropdownchecklist-dropcontainer");
		var maxW = 0;
		var maxH = 0;
		...
		this._setSize({
			width: maxW, // for scrolls not to appear 
			height: maxH // for scrolls not to appear
		});
  },
