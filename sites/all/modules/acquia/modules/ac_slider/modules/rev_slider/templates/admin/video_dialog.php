...
<div id="dialog_video" class="dialog-video" title="<?php _e("Add Youtube Layout",REVSLIDER_TEXTDOMAIN)?>" style="display:none">
	...
	<div class="video_left">
		...
		<div id="video_block_vimeo" class="video-select-block" style="display:none;" >
			...
			&nbsp;
			<button type="button" id="button_vimeo_search" class="button"><?php _e("search", REVSLIDER_TEXTDOMAIN)?></button>

			<img id="vimeo_loader" src="<?php echo $plugins_url?>/assets/loader.gif" style="display:none">
		...
		<div id="video_block_youtube" class="video-select-block">
			...
			&nbsp;
			<button type="button" id="button_youtube_search" class="button"><?php _e("search", REVSLIDER_TEXTDOMAIN)?></button>
			
			<img id="youtube_loader" src="<?php echo $plugins_url?>/assets/loader.gif" style="display:none">
			
			<div class="video_example">
				<?php _e("example",REVSLIDER_TEXTDOMAIN)?>:  cXwQjHRZieI
			</div>
		...
		<div id="video_hidden_controls" style="display:none;">
			...
			<input type="text" id="input_video_arguments" style="width:245px;" value="" data-youtube="<?php echo DEFAULT_YOUTUBE_ARGUMENTS?>" data-vimeo="<?php echo DEFAULT_VIMEO_ARGUMENTS?>" ></input>
