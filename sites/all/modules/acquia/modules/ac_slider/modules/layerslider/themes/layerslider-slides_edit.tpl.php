<?php include LS_ROOT_PATH . '/../themes/slider_edit_sample.php'; ?>
<form action="<?php echo $_SERVER['REQUEST_URI']?>" method="post" class="wrap ls-slider-form" id="ls-slider-form" novalidate="novalidate">
	...
	<!-- Title -->
	<h2>
		<?php print t('Editing slider: @slider', array('@slider' => $slider['properties']['title'])) ?>
		<a href="<?php print url(SLIDER_LIST_PATH, array('absolute' => TRUE))?>" class="add-new-h2"><?php _e('Back to the list', 'LayerSlider') ?></a>
	</h2>
	...
	<div id="ls-pages">
		...
		<div class="ls-page ls-settings ls-slider-settings active">
			<?php include LS_ROOT_PATH . '../themes/slider_edit_settings.php'; ?>
		</div>
...
<script type="text/javascript">
	...
	// Transition images
	var lsTrImgPath = '<?php echo $plugins_url ?>/img/';
