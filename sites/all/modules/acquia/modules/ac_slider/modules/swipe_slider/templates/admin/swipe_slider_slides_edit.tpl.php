          ...
          <td colspan="7">
			...
			<tbody class="ac-slide-options">
				<tr>
					...
					<td class="right"><?php print t('Background Image') ?></td>
					<td>
					...
					<td class="right"><?php t('Background Position') ?></td>
					<td>
						<select name="bg_position" data-help="<?php t('How the background will be positioned into the Slider') ?>">
							<?php foreach($bg_positions as $pos => $title):?>
								<option value="<?php print $pos?>"<?php echo $pos == 'center center' ? 'selected="selected"' : '' ?>><?php print $title?></option>
							<?php endforeach?>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td colspan="5"><textarea cols="100" rows="2" name="title" class="title" data-help="<?php print t('Enter the Slide title text..') ?>"></textarea>
				</tr>
				<tr>
					<td class="right"></td>
					<td><?php print t('Subtitle?') ?></td>
					<td colspan="5"><textarea cols="100" rows="2" name="subtitle" class="subtitle" data-help="<?php print t('Enter the Slide subtitle text.') ?>"></textarea>
				</tr>
					<tr>
						<td class="right"></td>
						<td class="right"><?php print t('Caption Position') ?></td>
						<td>
							<select name="caption_pos">
									<option value="lt"><?php print t('left top')?></option>
									<option value="lc" selected="selected"><?php print t('left center')?></option>
									<option value="lb"><?php print t('left bottom')?></option>
									<option value="ct"><?php print t('center top')?></option>
									<option value="cc"><?php print t('center center')?></option>
									<option value="cb"><?php print t('center bottom')?></option>
									<option value="rt"><?php print t('right top')?></option>
									<option value="rc"><?php print t('right center')?></option>
									<option value="rb"><?php print t('right bottom')?></option>
							</select>
						</td>
						<td class="right"><?php print t('Caption transition') ?></td>
						<td colspan="2">
							<select name="caption_trans">
								<?php foreach($transitions as $key => $title): ?>
					...
					<tr>
						<td class="right"></td>
						<td class="right"><?php print t('Menu Style') ?></td>
						<td>
							<select name="header_style">
								<option value="dark"><?php print t('Dark')?></option>
								<option value="light"><?php print t('Light')?></option>
							</select>
						</td>
						<td class="right"><?php print t('Slide overlay') ?></td>
						<td colspan="2">
							<select name="slide_overlay">
									<option value="none" selected="selected"><?php print t('None')?></option>
									<option value="white"><?php print t('White overlay')?></option>
									<option value="black"><?php print t('Black overlay')?></option>
							</select>
						</td>
					</tr>
...
<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" class="wrap ac-admin" id="ac-slider-form">
  ...
  <input type="hidden" name="slider_play" value="0">
	...
	<h2>
		<?php print t('Edit this Swipe Slider') ?>
	...
	<div id="ac-pages">
		...
		<div class="ac-page ac-settings">
            ...
            <tr>
						  <td class="right"></td>
              <td class="right"><?php print t('Slides background image style') ?></td>
              <td colspan="5">
                    ...
                    <?php endforeach?>
						...
						<tr>
						  <td class="right"></td>
							...
							<td colspan="5">
								<div class="reset-parent">
									<input type="hidden" name="background_fid" class="fid" value="<?php echo isset($slider['properties']['background_fid']) ? $slider['properties']['background_fid'] : '' ?>">
									<input type="text" name="background" class="<?php print $uploadClass?>" value="<?php echo isset($slider['properties']['background']) ? $slider['properties']['background'] : '' ?>" data-help="<?php print t('The slide image/background. Click into the field to open the Drupal Media Library to choose or upload an image.') ?>">
									<span class="ac-reset">x</span>
								</div>
							</td>
            </tr>
             ...
             <td>
               <div class="reset-parent">
                 ...
                 <span class="ac-reset">x</span>
					...
					<tr>
           	<td class="right"></td>
						<td class="right"><?php print t('fullheight?') ?></td>
						<td><input type="checkbox" name="fullheight"<?php echo ( isset($slider['properties']['fullheight']) && $slider['properties']['fullheight'] == 'true') ? ' checked="checked"' : '' ?>></td>
						
						<td class="right"><?php print t('Speed') ?></td>
						<td><input type="text" name="speed" value="<?php echo $slider['properties']['speed']?>" data-help="<?php print t('duration of animation between slides (in ms)')?>"></td>
						
						<td class="right"><?php print t('Pause') ?></td>
						<td colspan="3"><input type="text" name="pause" value="<?php echo $slider['properties']['pause']?>" data-help="<?php print t('duration of animation between slides (in ms)')?>"></td>
          </tr>
					<tr>
           	<td class="right"></td>
						<td class="right"><?php print t('Pager?') ?></td>
						<td><input type="checkbox" name="pager"<?php echo ( isset($slider['properties']['pager']) && $slider['properties']['pager'] == 'true') ? ' checked="checked"' : '' ?>></td>
						
						<td class="right"><?php print t('Prev/Next navigation?') ?></td>
						<td colspan="3"><input type="checkbox" name="nav"<?php echo ( isset($slider['properties']['nav']) && $slider['properties']['nav'] == 'true') ? ' checked="checked"' : '' ?>></td>
          </tr>
				</table> 
						...
						<tbody class="ac-slide-options">
							<tr>
								...
								<td>
									<select name="bg_position" data-help="<?php t('How the background will be positioned into the Slider') ?>">
										<?php foreach($bg_positions as $pos => $title):?>
											<option value="<?php print $pos?>"<?php echo isset($layer['properties']['bg_position']) && $layer['properties']['bg_position'] == $pos ? 'selected="selected"' : '' ?>><?php print $pos?></option>
										<?php endforeach?>
									</select>
								</td>
							</tr>
							...
							<tr>
								<td class="right"></td>
								<td><?php print t('Title?') ?></td>
								<td colspan="5"><textarea cols="100" rows="2" name="title" class="title" data-help="<?php print t('Enter the Slide title text..') ?>"><?php echo $layer['properties']['title']?></textarea>
							</tr>
							
							<tr>
								<td class="right"></td>
								<td><?php print t('Subtitle?') ?></td>
								<td colspan="5"><textarea cols="100" rows="2" name="subtitle" class="subtitle" data-help="<?php print t('Enter the Slide subtitle text.') ?>"><?php echo $layer['properties']['subtitle']?></textarea>
							</tr>
							...
							<tr>
								...
								<td>
									<select name="caption_pos">
										<option value="lt"<?php echo ($layer['properties']['caption_pos'] == 'lt') ? 'selected="selected"' : ''?>><?php print t('left top')?></option>
										<option value="lc"<?php echo ($layer['properties']['caption_pos'] == 'lc') ? 'selected="selected"' : ''?>><?php print t('left center')?></option>
										<option value="lb"<?php echo ($layer['properties']['caption_pos'] == 'lb') ? 'selected="selected"' : ''?>><?php print t('left bottom')?></option>
										
										<option value="ct"<?php echo ($layer['properties']['caption_pos'] == 'ct') ? 'selected="selected"' : ''?>><?php print t('center top')?></option>
										<option value="cc"<?php echo ($layer['properties']['caption_pos'] == 'cc') ? 'selected="selected"' : ''?>><?php print t('center center')?></option>
										<option value="cb"<?php echo ($layer['properties']['caption_pos'] == 'cb') ? 'selected="selected"' : ''?>><?php print t('center bottom')?></option>
										
										<option value="rt"<?php echo ($layer['properties']['caption_pos'] == 'rt') ? 'selected="selected"' : ''?>><?php print t('right top')?></option>
										<option value="rc"<?php echo ($layer['properties']['caption_pos'] == 'rc') ? 'selected="selected"' : ''?>><?php print t('right center')?></option>
										<option value="rb"<?php echo ($layer['properties']['caption_pos'] == 'rb') ? 'selected="selected"' : ''?>><?php print t('right bottom')?></option>
									</select>
								</td>
								<td class="right"><?php print t('Caption transition') ?></td>
								<td colspan="2">
									<select name="caption_trans">
										<?php foreach($transitions as $key => $title): ?>
										<option value="<?php print $key?>"<?php echo ($layer['properties']['caption_trans'] == $key) ? 'selected="selected"' : ''?>><?php print $title?></option>
										<?php endforeach?>
									</select>
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<select name="header_style">
										<option value="dark"<?php echo ($layer['properties']['header_style'] == 'dark') ? ' selected="selected"' : ''?>><?php print t('Dark')?></option>
										<option value="light"<?php echo ($layer['properties']['header_style'] == 'light') ? ' selected="selected"' : ''?>><?php print t('Light')?></option>
									</select>
								</td>
								<td class="right"><?php print t('Slide overlay') ?></td>
								<td colspan="2">
									<select name="slide_overlay">
											<option value="none"<?php echo (isset($layer['properties']['slide_overlay']) && $layer['properties']['slide_overlay'] == 'none') ? ' selected="selected"' : ''?>><?php print t('None')?></option>
											<option value="white"<?php echo (isset($layer['properties']['slide_overlay']) && $layer['properties']['slide_overlay'] == 'white') ? ' selected="selected"' : ''?>><?php print t('White overlay')?></option>
											<option value="black"<?php echo (isset($layer['properties']['slide_overlay']) && $layer['properties']['slide_overlay'] == 'black') ? ' selected="selected"' : ''?>><?php print t('Black overlay')?></option>
									</select>
								</td>
							</tr>
