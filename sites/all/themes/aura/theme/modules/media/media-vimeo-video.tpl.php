...
if (!isset($fluid) || !$fluid) {
   $style = ' style="width: '.ac_check_unit($width).'; height: '.ac_check_unit($height).'"';
}else{
  $style = '';
}
?>
<div class="media-vimeo-outer-wrapper ac-video" id="media-vimeo-<?php print $id; ?>"<?php print $style; ?>>
