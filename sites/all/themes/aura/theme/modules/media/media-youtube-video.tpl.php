...
?>
<div class="<?php print $classes; ?> ac-video media-youtube-<?php print $id; ?>">
  <iframe class="media-youtube-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>;theme=light" frameborder="0" allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
